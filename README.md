...
## ORF Step 1 (Help Scout -> NetSuite)

### Bookmarklet (copy/paste into a browser bookmark URL field)
...
3. Paste the bookmarklet into the URL field
4. While viewing a Help Scout conversation, click the bookmark
